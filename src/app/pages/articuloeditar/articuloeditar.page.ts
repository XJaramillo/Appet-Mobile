...
export class ArticuloeditarPage implements OnInit {
  ...
  async editarTitulo(){
    ...
    const alerta = await this.alertController.create({
      ...
      header: 'Título',
      message: '¿Está seguro de cambiar el título del servicio?',
      inputs: [
        {
          name: 'titulo',
          type: 'text', 
  ...
  async editarDescripcion(){
    ...
    const alerta = await this.alertController.create({
      cssClass: 'my-custom-class',
      header: 'Descripción',
      message: '¿Está seguro de cambiar la descripción del servicio?',
      inputs: [
        {
          name: 'descripcion',
          type: 'text', 
  ...
  async editarTelefono(){
    const alerta = await this.alertController.create({
      cssClass: 'my-custom-class',
      header: 'Teléfono',
      message: '¿Está seguro de cambiar el teléfono de contacto?',
      inputs: [
        {
          name: 'telefono',
          type: 'text', 
  ...
  async editarCosto(){
    const alerta = await this.alertController.create({
      cssClass: 'my-custom-class',
      header: 'Precio',
      message: '¿Está seguro de cambiar el precio del servicio?',
      inputs: [
        {
          name: 'costo',
          type: 'number', 
